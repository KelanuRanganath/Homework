...
% LaTeX expands commands with a space, so the Lua parser gets confused because I use whitespace to separate fractions.
...
% Figure out how to auto-insert \\ at the end of an equation line
...
% Using the differential operator before = causes the pdf to fail to compile
% ppU0S = -> \frac{\partial S&=}{\partial U}, this makes no sense
% This also happens after the equals, goes away when manually aligning

% Fractions fail if there's no preceeding whitespace, this is a problem at the start of a line
% We should be able to add a start of line character to the pattern

% Diff ops. and likely other patterns fail at the end of the line, expects " " gets "\\"
